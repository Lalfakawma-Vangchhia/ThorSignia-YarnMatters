          ...
          <div className="lg:col-span-2">
            <div className="flex items-center mb-6">
              <img 
                ...
                alt="Thor Signia" 
                className="h-[60px] w-auto object-contain bg-white rounded-md p-1" 
              />
            </div>
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-start group">
                ...
                <span className="text-gray-300">123 Innovation Drive, San Francisco, CA 94105</span>
              </li>
              <li className="flex items-start group">
                ...
                <span className="text-gray-300">info@thorsignia.com</span>
              </li>
              <li className="flex items-start group">
                <div className="w-8 h-8 rounded-lg bg-white/10 flex items-center justify-center mr-3 text-[#88bf42] group-hover:bg-white/20 transition-colors">
