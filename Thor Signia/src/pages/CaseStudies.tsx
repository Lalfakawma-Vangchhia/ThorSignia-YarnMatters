...
const CaseStudiesPage = () => {
  // Function to render a magazine-style featured case study (spanning 2 columns)
      ...
      <div className="absolute bottom-8 left-8 right-8 text-white z-10">
        <div className="flex justify-between items-end">
          <div>
            ...
            <p className="text-white/90 max-w-2xl mb-4">{study.summary}</p>
          ...
          <Button 
            variant="outline" 
            size="lg" 
            className="border-white text-white bg-transparent hover:bg-white/20 transition-all duration-300 group-hover:scale-105 pointer-events-none"
          >
  ...
  const renderCaseStudy = (study, index) => (
    ...
    >
      <div 
        className="absolute inset-0 bg-cover bg-center transition-all duration-300 group-hover:scale-105 group-hover:brightness-110"
        style={{ backgroundImage: `url(${study.imageUrl})` }}
      ></div>
      ...
      <section className="pt-36 pb-16 bg-gradient-to-r from-[#10b4b7]/10 to-[#9ac857]/10">
        <div className="container mx-auto px-4 md:px-6">
          <div className="max-w-3xl mx-auto text-center">
            <div className="inline-block px-3 py-1 mb-6 rounded-full bg-gradient-to-r from-[#10b4b7]/20 to-[#9ac857]/20 text-[#1c9f1e] text-sm font-medium mt-2">
