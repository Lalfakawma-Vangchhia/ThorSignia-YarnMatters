        ...
        <div className="container mx-auto px-4 md:px-6 relative z-10">
          <div className="max-w-6xl mx-auto">
            <div className="flex flex-col md:flex-row items-start justify-between">
              <div>
                <Link to="/case-studies" className="inline-flex items-center text-white hover:text-[#31adab] mb-6 transition duration-200">
                ...
                <span 
                  ...
                  style={{ background: `linear-gradient(to right, #31adab 0%, #31adab 100%)`, color: 'white' }}
                >
                  {caseStudy.category}
                </span>
              ...
              {relatedCaseStudies.map((study, index) => (
                ...
                >
                  <div className="h-48 overflow-hidden relative">
                    ...
                    <span 
                      className="absolute bottom-4 left-4 px-2 py-1 rounded-full text-xs font-medium text-white" 
