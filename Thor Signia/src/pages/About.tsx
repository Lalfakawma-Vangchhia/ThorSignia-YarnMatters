...
const AboutPage = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col"> {/* Added flex-col for main div */}
        ...
        <div className="container mx-auto px-4 md:px-6 relative z-10 max-w-6xl hover:scale-[1.01] transition-transform duration-300">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <Fade triggerOnce direction="up" delay={50}>
              <div className="inline-block px-3 py-1 mb-6 mx-2 sm:mx-4 md:mx-0 mt-[10px] sm:mt-0 rounded-full bg-[#009898]/10 text-[#009898] font-medium text-sm">
                Our Story
              </div>
            </Fade>
      ...
      {/* CTA Section - Adding animations here */}
      <section className="py-20 bg-[#009898] text-white relative overflow-hidden">
        <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1515187029135-18ee286d815b?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1050&q=80')] bg-cover bg-center opacity-10"></div>
        <div className="container mx-auto px-4 md:px-6 relative z-10 max-w-6xl hover:scale-[1.01] transition-transform duration-300">
          <div className="max-w-4xl mx-auto text-center">
             ...
             {/* Animate buttons flex container with cascade */}
             <Fade triggerOnce cascade damping={0.2} direction="up" delay={300}>
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                  ...
                  <Button
                    className="border-2 border-white bg-[#88bf42] px-8 py-6 text-lg shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1 rounded-lg"
                    asChild
                  >
                    <Link to="/contact">
